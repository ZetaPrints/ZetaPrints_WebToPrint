    ...
    implements ZetaPrints_Api
{
    ...
    public function map()
    {
        ...
        $this->warning(
            'Warning: products were created with general set of properties. Update other product properties using bulk edit to make them operational.'
        );
    }
    ...
    protected function _getWebsitesForAssign()
    {
        if (count(Mage::app()->getWebsites()) < 2) {
            return [Mage::app()->getWebsite(true)->getId()];
        }
