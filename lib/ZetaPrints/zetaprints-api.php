...
function zetaprints_get_templates_from_catalog($url, $key, $catalog_guid)
{
    ...
    $response = zetaprints_get_content_from_url(
        "$url/API.aspx?page=api-templates;CorporateID=$catalog_guid;ApiKey=$key"
    );
...
function zetaprints_get_template_detailes($url, $key, $template_guid)
{
    ...
    $response = zetaprints_get_content_from_url(
        "$url/API.aspx?page=api-template;TemplateID=$template_guid;ApiKey=$key"
    );
...
function zetaprints_get_template_details_as_xml(
    $url,
    $key,
    $template_guid,
    $data = null
...
function zetaprints_complete_order($url, $key, $order_guid, $new_guid = null)
{
    ...
    $response = zetaprints_get_content_from_url(
        "$url/api.aspx?page=api-order-complete;ApiKey=$key;OrderID=$order_guid{$new_guid_parameter}"
    );
