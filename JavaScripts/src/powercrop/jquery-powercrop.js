module.exports = function ($) {
    ...
    const methods = {
        ...
        state: function () {
            ...
            if ($container) {
                const $viewport = $container.find('.powercrop-viewport');
                const $image = $container.find('.powercrop-image');
    ...
    $.fn.power_crop = function (method) {
        ...
        if (!settings.simple) {
            $image.resizable({
                ...
                stop: function (event, ui) {
                    ...
                    const image_width = Math.round(ui.size.width);
                    const image_height = Math.round(ui.size.height);
        ...
        const $viewport = $('<div class="powercrop-viewport" />')
            .appendTo($container);
        ...
        if (!settings.simple) {
            $image_top.resizable({
                ...
                stop: function (event, ui) {
                    const image_top_position = $image_top_wrapper.position();
